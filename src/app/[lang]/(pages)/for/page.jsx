...
const T = {
  uk: {
    seo: { title: "Детектор брехні для бізнесу: рішення для галузі — EyeDetect", description: "Детектор брехні EyeDetect для юристів, банків, охорони, HR, логістики, ритейлу, мілтеху, клінік, страхових та інших. Львів, виїзд по Україні, онлайн.", keywords: ["детектор брехні для бізнесу", "поліграф для компанії", "перевірка персоналу галузі", "EyeDetect для бізнесу"], crumbHome: "Головна", crumb: "Для кого" },
  ...
  ru: {
    seo: { title: "Детектор лжи для бизнеса: решения для отрасли — EyeDetect", description: "Проверка на детекторе лжи EyeDetect для юристов, банков, охраны, HR, логистики, ритейла, милтеха, клиник, страховых и других. Львов, выезд по Украине, онлайн.", keywords: ["детектор лжи для бизнеса", "полиграф для компании", "проверка персонала отрасли", "EyeDetect для бизнеса"], crumbHome: "Главная", crumb: "Для кого" },
  ...
  en: {
    seo: { title: "Lie Detector for Business: Solutions by Industry — EyeDetect", description: "EyeDetect lie detector testing for lawyers, banks, security, HR, logistics, retail, miltech, clinics, insurers and more. Lviv, on-site in Ukraine, online.", keywords: ["lie detector for business", "polygraph for companies", "employee screening by industry", "EyeDetect for business"], crumbHome: "Home", crumb: "For whom" },
