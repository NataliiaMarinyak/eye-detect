// Квіз розрахунку вартості (вікно поверх сторінки).
...
export const quizData = {
  uk: {
    ...
    contact: {
      ...
      errPhone: "Вкажіть номер телефону. Наприклад: +380 67 123 45 67 або 067 123 45 67",
      errPhoneTg: "Вкажіть номер телефону або @username у Telegram.",
      phoneTgHint: "Для Telegram можна вказати @username замість номера.",
      ...
      text: "Ми працюємо цілодобово. Спеціаліст порахує точну вартість і зв'яжеться з вами протягом 15–30 хвилин. Терміново: ",
  ...
  ru: {
    ...
    contact: {
      ...
      errPhone: "Укажите номер телефона. Например: +380 67 123 45 67 или 067 123 45 67",
      errPhoneTg: "Укажите номер телефона или @username в Telegram.",
      phoneTgHint: "Для Telegram можно указать @username вместо номера.",
      ...
      text: "Мы работаем круглосуточно. Специалист рассчитает точную стоимость и свяжется с вами в течение 15–30 минут. Срочно: ",
  ...
  en: {
    ...
    contact: {
      ...
      errPhone: "Please enter your phone number. For example: +380 67 123 45 67 or +48 512 345 678",
      errPhoneTg: "Please enter your phone number or Telegram @username.",
      phoneTgHint: "For Telegram, you can enter your @username instead of a number.",
      ...
      text: "We work 24/7. The examiner will calculate the exact price and contact you within 15–30 minutes. Urgent: ",
      call: "Call now",
      close: "Close",
    },
  },
