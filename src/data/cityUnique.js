...
export const cityUnique = {
  tallinn: {
    uk: {
      ...
      seoDescription: "Перевірка на детекторі брехні в Таллінні: офісу в Естонії немає. Онлайн-тест VerifEye з телефона сьогодні або виїзд спеціаліста з EyeDetect, коли збереться кілька заявок.",
    ...
    ru: {
      ...
      seoDescription: "Проверка на детекторе лжи в Таллинне: офиса в Эстонии нет. Онлайн-тест VerifEye с телефона сегодня или выезд специалиста с EyeDetect, когда соберётся несколько заявок.",
    ...
    en: {
      ...
      faq: [
        ...
        { q: "How much does the specialist's travel to Tallinn cost?", a: "The bus from Lviv to Tallinn takes 30–40 hours by timetable, and a one-way ticket costs roughly UAH 3,400–6,000 depending on the dates. A bus to Warsaw (10–11 hours) followed by a flight to Tallinn (about 2 hours) is faster, but the cheapest fares charge extra for a bag with the equipment. Travel and the venue are paid separately from the test. We will give you the exact round-trip amount once the dates are known." },
