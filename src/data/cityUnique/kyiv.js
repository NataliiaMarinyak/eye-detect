...
export const kyiv = {
  uk: {
    ...
    seoDescription: "Детектор брехні в Києві: виїзд спеціаліста з EyeDetect — 12 000 ₴ під ключ або онлайн-тест VerifEye сьогодні від 2 500 ₴. Звіт за 5 хвилин.",
    ...
    faq: [
      { q: "Де пройти поліграф у Києві?", a: "Офісу в Києві немає, тому є два варіанти. Онлайн-тест VerifEye можна пройти вже сьогодні з телефона, у тихій кімнаті вдома чи в офісі. Тест EyeDetect проводимо під час виїзду: спеціаліст приїжджає зі Львова з обладнанням у ваш офіс або в іншу тиху кімнату." },
  ...
  ru: {
    ...
    seoDescription: "Проверка на детекторе лжи в Киеве: выезд специалиста с EyeDetect — 12 000 ₴ под ключ или онлайн-тест VerifEye сегодня от 2 500 ₴. Отчёт за 5 минут.",
    ...
    faq: [
      { q: "Где пройти полиграф в Киеве?", a: "Офиса в Киеве нет, поэтому есть два варианта. Онлайн-тест VerifEye можно пройти уже сегодня с телефона, в тихой комнате дома или в офисе. Тест EyeDetect проводим во время выезда: специалист приезжает из Львова с оборудованием в ваш офис или в другую тихую комнату." },
  ...
  en: {
    ...
    seoDescription: "Lie detector test in Kyiv: book an EyeDetect visit for UAH 12,000 all-inclusive or take the VerifEye online test today from UAH 2,500. Report in 5 minutes.",
