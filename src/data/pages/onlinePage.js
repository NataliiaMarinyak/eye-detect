...
export const onlinePage = {
  uk: {
    ...
    hero: {
      ...
      facts: ["близько 10 хвилин", "точність 84–89% (дані Converus)", "звіт у PDF одразу після тесту", "від 2 500 ₴"],
  ...
  ru: {
    ...
    hero: {
      ...
      facts: ["около 10 минут", "точность 84–89% (данные Converus)", "отчёт в PDF сразу после теста", "от 2 500 ₴"],
