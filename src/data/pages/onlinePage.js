...
export const onlinePage = {
  uk: {
    ...
    hero: {
      ...
      facts: ["близько 10 хвилин", "точність 84–89% (дані Converus)", "звіт у PDF того ж дня", "від 2 500 ₴"],
  ...
  ru: {
    ...
    hero: {
      ...
      facts: ["около 10 минут", "точность 84–89% (данные Converus)", "отчёт в PDF в тот же день", "от 2 500 ₴"],
