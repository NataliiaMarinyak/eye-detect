  ...
  uk: {
    ...
    why: {
      ...
      items: [
        ...
        { title: "Точність: до 84% у реальних умовах", text: "У валідаційному дослідженні Converus 2024 року (123 учасники, лабораторні умови, тест VerifEye 3R) точність склала 89%. У реальних умовах Converus заявляє до 84%: освітлення, телефон і дотримання інструкцій впливають на результат, тому ми даємо детальну інструкцію перед тестом. EyeDetect у кабінеті точніший (86–88%)." },
  ...
  ru: {
    ...
    why: {
      ...
      items: [
        ...
        { title: "Точность: до 84% в реальных условиях", text: "В валидационном исследовании Converus 2024 года (123 участника, лабораторные условия, тест VerifEye 3R) точность составила 89%. В реальных условиях Converus заявляет до 84%: освещение, телефон и соблюдение инструкций влияют на результат, поэтому мы даём подробную инструкцию перед тестом. EyeDetect в кабинете точнее (86–88%)." },
