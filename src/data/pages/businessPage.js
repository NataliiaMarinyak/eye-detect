...
export const businessPage = {
  uk: {
    seo: {
      ...
      description: "Перевірка кандидатів і працівників на EyeDetect: 6–8 осіб за день, без датчиків, звіт по кожному того ж дня. Крадіжки, витік інформації, службові розслідування. Виїзд в офіс по Україні.",
    ...
    hero: {
      ...
      sub: "Найм, планова перевірка, крадіжка чи витік. Приїжджаємо з обладнанням EyeDetect у ваш офіс, кожен тест 30–45 хвилин, звіт по кожній людині того ж дня. Без датчиків, без стресу для команди.",
    ...
    why: {
      ...
      rows: [
        ...
        ["Стрес для команди", "мінімальний", "високий"],
      ],
    },
    process: {
      ...
      steps: [
        ...
        { title: "Згода працівників", text: "Кожен підписує згоду на тест і читає питання. Відмова теж інформація, але змушувати нікого не можна." },
    ...
    pricing: {
      ...
      note: "Ціна за одну людину залежить від кількості осіб. Точну суму для вашої ситуації надішлемо після короткої розмови.",
  ...
  ru: {
    ...
    hero: {
      ...
      sub: "Найм, плановая проверка, кража или утечка. Приезжаем с оборудованием EyeDetect в ваш офис, каждый тест 30–45 минут, отчёт по каждому человеку в тот же день. Без датчиков, без стресса для команды.",
    ...
    why: {
      ...
      rows: [
        ...
        ["Стресс для команды", "минимальный", "высокий"],
      ],
    },
    process: {
      ...
      steps: [
        ...
        { title: "Согласие сотрудников", text: "Каждый подписывает согласие на тест и читает вопросы. Отказ тоже информация, но заставлять никого нельзя." },
    ...
    pricing: {
      title: "Сколько стоит",
      note: "Цена за одного человека зависит от количества людей. Точную сумму для вашей ситуации отправим после короткого разговора.",
