...
export const eyedetectPage = {
  uk: {
    seo: {
      ...
      description:
        "EyeDetect: камера 60 кадрів за секунду фіксує мимовільні реакції очей. Без датчиків, 30–45 хвилин, точність 86–88% за даними Converus. Обмеження і різниця з класичним поліграфом.",
    ...
    compare: {
      ...
      rows: [
        ...
        ["Точність (дані виробника)", "86–88%", "до 84%", "залежить від спеціаліста"],
    ...
    limits: {
      ...
      items: [
        "Точність 86–88% означає, що приблизно один результат із восьми може бути помилковим. Тому ми ставимо конкретні питання, а недійсний тест проводимо повторно зі знижкою 50%.",
    ...
    faq: [
      { q: "Чи можна обманути EyeDetect?", a: "Свідомо контролювати зіницю і мікрорухи очей неможливо. Якщо людина відповідає навмання, затягує відповіді або не читає твердження, тест визнається недійсним і проводиться повторно." },
  ...
  ru: {
    ...
    compare: {
      ...
      rows: [
        ...
        ["Точность (данные производителя)", "86–88%", "до 84%", "зависит от специалиста"],
    ...
    limits: {
      ...
      items: [
        "Точность 86–88% означает, что примерно один результат из восьми может быть ошибочным. Поэтому мы ставим конкретные вопросы, а недействительный тест проводим повторно со скидкой 50%.",
    ...
    faq: [
      { q: "Можно ли обмануть EyeDetect?", a: "Сознательно контролировать зрачок и микродвижения глаз невозможно. Если человек отвечает наугад, затягивает ответы или не читает утверждения, тест признаётся недействительным и проводится повторно." },
