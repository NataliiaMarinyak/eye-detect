...
export const eyedetectPage = {
  uk: {
    ...
    hero: {
      ...
      h1: "Детектор брехні EyeDetect: як працює і чим відрізняється від класичного поліграфа",
  ...
  ru: {
    ...
    hero: {
      ...
      h1: "Детектор лжи EyeDetect: как работает и чем отличается от классического полиграфа",
