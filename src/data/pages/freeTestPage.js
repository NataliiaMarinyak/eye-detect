...
export const freeTestPage = {
  uk: {
    seo: {
      ...
      description: "Спробуйте справжній детектор брехні онлайн безкоштовно: загадайте цифру, пройдіть тест VerifEye зі смартфона, і алгоритм Converus назве вашу цифру.",
  ...
  ru: {
    seo: {
      ...
      description: "Попробуйте настоящий детектор лжи онлайн бесплатно: загадайте цифру, пройдите тест VerifEye со смартфона, и алгоритм Converus назовёт вашу цифру.",
