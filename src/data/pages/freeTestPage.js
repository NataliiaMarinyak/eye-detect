...
export const freeTestPage = {
  uk: {
    ...
    hero: {
      ...
      sub: "Це не гра і не застосунок-жарт. Ви записуєте цифру від 1 до 6 і нікому її не кажете, потім близько 5 хвилин відповідаєте на запитання у застосунку VerifEye, заперечуючи всі цифри, зокрема й свою. Алгоритм Converus визначає вашу цифру за реакціями очей. Так ви на собі відчуєте, як працює технологія, перш ніж замовляти справжню перевірку.",
  ...
  ru: {
    ...
    hero: {
      ...
      sub: "Это не игра и не приложение-шутка. Вы записываете цифру от 1 до 6 и никому её не говорите, потом около 5 минут отвечаете на вопросы в приложении VerifEye, отрицая все цифры, включая свою. Алгоритм Converus определяет вашу цифру по реакциям глаз. Так вы на себе почувствуете, как работает технология, прежде чем заказывать настоящую проверку.",
