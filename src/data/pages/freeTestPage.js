...
export const freeTestPage = {
  uk: {
    ...
    hero: {
      ...
      sub: "Це не гра і не застосунок-жарт. Ви загадуєте цифру і нікому її не кажете, проходите короткий тест VerifEye зі смартфона, а алгоритм Converus визначає загадану цифру за реакціями ваших очей. Так ви на собі відчуєте, як працює технологія, перш ніж замовляти справжню перевірку.",
      facts: ["0 ₴, без зобов'язань", "кілька хвилин зі смартфона", "той самий VerifEye, що й у платних тестах", "результат того ж дня"],
    ...
    blocks: [
      { type: "steps", tone: "white", title: "Як це відбувається", items: [
        ...
        { title: "Загадуєте цифру", text: "Нікому її не кажете і не записуєте. Сідаєте у тихій кімнаті з рівним освітленням, без окулярів, телефон перед обличчям." },
        { title: "Проходите тест", text: "Застосунок ставить кілька тверджень про цифри голосом, ви відповідаєте вголос. Камера фіксує реакції очей: зіницю, рухи, моргання." },
        { title: "Отримуєте відповідь", text: "Алгоритм Converus рахує реакції і визначає, яку цифру ви загадали. Ми повідомляємо результат вам. Далі вирішуєте самі, чи потрібен справжній тест." },
      ] },
      { type: "cards", title: "Чому це чесний тест, а не фокус", cols: 2, items: [
        ...
        { title: "Реакції, які не контролюються", text: "Коли ви бачите «свою» цифру, зіниця і рухи очей реагують інакше, навіть якщо ви спокійно кажете «ні». Саме це вимірює алгоритм, а не ваш голос чи міміку." },
        ...
        { title: "Це демонстрація, а не перевірка", text: "Тест на цифру показує принцип. Справжня перевірка будується на ваших питаннях і триває близько 10 хвилин онлайн або 30–45 хвилин у кабінеті." },
      ] },
  ...
  ru: {
    ...
    hero: {
      ...
      sub: "Это не игра и не приложение-шутка. Вы загадываете цифру и никому её не говорите, проходите короткий тест VerifEye со смартфона, а алгоритм Converus определяет загаданную цифру по реакциям ваших глаз. Так вы на себе почувствуете, как работает технология, прежде чем заказывать настоящую проверку.",
      facts: ["0 ₴, без обязательств", "несколько минут со смартфона", "тот же VerifEye, что и в платных тестах", "результат в тот же день"],
    ...
    blocks: [
      { type: "steps", tone: "white", title: "Как это происходит", items: [
        ...
        { title: "Загадываете цифру", text: "Никому её не говорите и не записываете. Садитесь в тихой комнате с ровным освещением, без очков, телефон перед лицом." },
        { title: "Проходите тест", text: "Приложение задаёт несколько утверждений о цифрах голосом, вы отвечаете вслух. Камера фиксирует реакции глаз: зрачок, движения, моргание." },
        { title: "Получаете ответ", text: "Алгоритм Converus считает реакции и определяет, какую цифру вы загадали. Мы сообщаем результат вам. Дальше решаете сами, нужен ли настоящий тест." },
      ] },
      { type: "cards", title: "Почему это честный тест, а не фокус", cols: 2, items: [
        ...
        { title: "Реакции, которые не контролируются", text: "Когда вы видите «свою» цифру, зрачок и движения глаз реагируют иначе, даже если вы спокойно говорите «нет». Именно это измеряет алгоритм, а не ваш голос или мимику." },
        ...
        { title: "Это демонстрация, а не проверка", text: "Тест на цифру показывает принцип. Настоящая проверка строится на ваших вопросах и длится около 10 минут онлайн или 30–45 минут в кабинете." },
      ] },
  ...
  en: {
    ...
    hero: {
      ...
      sub: "This is not a game or a joke app. You think of a number and tell no one, take a short VerifEye test on your smartphone, and the Converus algorithm identifies your number from your eye reactions. You feel how the technology works on yourself before ordering a real test.",
      facts: ["free, no obligations", "a few minutes on a smartphone", "the same VerifEye used in paid tests", "result the same day"],
    ...
    blocks: [
      { type: "steps", tone: "white", title: "How it works", items: [
        ...
        { title: "Think of a number", text: "Tell no one and do not write it down. Sit in a quiet room with even lighting, no glasses, phone in front of your face." },
        { title: "Take the test", text: "The app reads several statements about numbers aloud, you answer aloud. The camera records eye reactions: pupil, movements, blinks." },
        { title: "Get the answer", text: "The Converus algorithm scores the reactions and identifies the number you had in mind. We send you the result. Then you decide whether you need a real test." },
      ] },
      { type: "cards", title: "Why this is an honest test, not a trick", cols: 2, items: [
        ...
        { title: "Reactions you cannot control", text: "When you see “your” number, your pupil and eye movements react differently, even if you calmly say “no”. That is what the algorithm measures, not your voice or facial expression." },
