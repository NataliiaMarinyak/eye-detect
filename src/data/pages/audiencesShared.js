...
export const cta = {
  uk: (service) => ({ type: "cta", title: "Обговорити вашу задачу", text: "Напишіть, кого і що потрібно перевірити. Відповімо цілодобово, протягом 15–30 хвилин, і запропонуємо формат тесту під вашу ситуацію.", button: "Отримати пропозицію", service, secondaryHref: "/faq", secondaryLabel: "Питання і відповіді" }),
  ru: (service) => ({ type: "cta", title: "Обсудить вашу задачу", text: "Напишите, кого и что нужно проверить. Ответим круглосуточно, в течение 15–30 минут, и предложим формат теста под вашу ситуацию.", button: "Получить предложение", service, secondaryHref: "/faq", secondaryLabel: "Вопросы и ответы" }),
  en: (service) => ({ type: "cta", title: "Discuss your case", text: "Tell us who and what needs to be checked. We reply 24/7, within 15–30 minutes, and suggest a test format for your situation.", button: "Get a proposal", service, secondaryHref: "/faq", secondaryLabel: "Questions and answers" }),
};
...
export const howVerifeye = {
  uk: { type: "steps", tone: "white", title: "Як проходить VerifEye онлайн", items: [
    ...
    { title: "Тест 15–20 хвилин", text: "Питання звучать голосом, кандидат відповідає вголос. Фронтальна камера фіксує зіницю, рухи очей і моргання." },
  ...
  ru: { type: "steps", tone: "white", title: "Как проходит VerifEye онлайн", items: [
    ...
    { title: "Тест 15–20 минут", text: "Вопросы звучат голосом, кандидат отвечает вслух. Фронтальная камера фиксирует зрачок, движения глаз и моргание." },
  ...
  en: { type: "steps", tone: "white", title: "How VerifEye online works", items: [
    ...
    { title: "Test: 15–20 minutes", text: "The questions are spoken, and the candidate answers aloud. The front camera records the pupil, eye movements, and blinking." },
...
export const how = {
  uk: { type: "steps", tone: "white", title: "Як проходить перевірка", items: [
    ...
    { title: "Тест 30–45 хвилин", text: "Людина відповідає «правда» або «неправда» на екрані, камера фіксує реакції очей. Датчиків на тілі немає." },
  ...
  ru: { type: "steps", tone: "white", title: "Как проходит проверка", items: [
    ...
    { title: "Тест 30–45 минут", text: "Человек отвечает «правда» или «неправда» на экране, камера фиксирует реакции глаз. Датчиков на теле нет." },
  ...
  en: { type: "steps", tone: "white", title: "How the test works", items: [
    ...
    { title: "Test: 30–45 minutes", text: "The person answers “true” or “false” on screen while the camera records eye reactions. No sensors on the body." },
