...
const shared = {
  uk: {
    ...
    online: { title: "VerifEye онлайн", text: "Близько 10 хвилин з телефона, з будь-якого міста. Звіт у PDF того ж дня.", price: "від 2 500 ₴", cta: "Пройти онлайн" },
  ...
  ru: {
    ...
    online: { title: "VerifEye онлайн", text: "Около 10 минут с телефона, из любого города. Отчёт в PDF в тот же день.", price: "от 2 500 ₴", cta: "Пройти онлайн" },
  ...
  en: {
    ...
    online: { title: "VerifEye online", text: "About 10 minutes from a phone, from any city. PDF report the same day.", price: "from UAH 2,500", cta: "Take the online test" },
...
export const situations = [
  {
    ...
    uk: {
      ...
      faq: [
        ...
        { q: "Партнер в іншому місті. Що робити?", a: "VerifEye онлайн: ми надсилаємо посилання, людина проходить тест з телефона у тихій кімнаті, звіт приходить вам на пошту того ж дня." },
    ...
    ru: {
      ...
      faq: [
        ...
        { q: "Партнёр в другом городе. Что делать?", a: "VerifEye онлайн: мы отправляем ссылку, человек проходит тест с телефона в тихой комнате, отчёт приходит вам на почту в тот же день." },
    ...
    en: {
      ...
      faq: [
        ...
        { q: "My partner is in another city. What can we do?", a: "VerifEye online: we send a link, the person takes the test from a phone in a quiet room, and the report arrives in your inbox the same day." },
