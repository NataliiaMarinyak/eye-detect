...
export const situations = [
  {
    ...
    uk: {
      ...
      h1: "Перевірка на вірність на детекторі брехні: правда за одну зустріч або онлайн",
      sub: "Коли підозри не дають жити, а розмови ходять по колу, тест дає конкретну відповідь на конкретні питання. Конкретні питання про конкретний період, результат того ж дня, і ніхто, крім вас, його не побачить.",
    ...
    ru: {
      ...
      h1: "Проверка на верность на детекторе лжи: правда за одну встречу или онлайн",
      sub: "Когда подозрения не дают жить, а разговоры ходят по кругу, тест даёт конкретный ответ на конкретные вопросы. Конкретные вопросы о конкретном периоде, результат в тот же день, и никто, кроме вас, его не увидит.",
  ...
  },
  {
    ...
    uk: {
      ...
      h1: "Витік даних чи комерційної таємниці: знайти джерело на детекторі брехні",
    ...
    ru: {
      ...
      h1: "Утечка данных или коммерческой тайны: найти источник на детекторе лжи",
  ...
  },
  {
    ...
    uk: {
      ...
      h1: "Перевірка кандидата на детекторі брехні перед наймом: факти замість резюме",
    ...
    ru: {
      ...
      h1: "Проверка кандидата на детекторе лжи перед наймом: факты вместо резюме",
  ...
  },
  {
    ...
    uk: {
      ...
      h1: "Слово проти слова: детектор брехні як об'єктивна основа для рішення",
    ...
    ru: {
      ...
      h1: "Слово против слова: детектор лжи как объективная основа для решения",
