...
const shared = {
  uk: {
    ...
    online: { title: "VerifEye онлайн", text: "До 15 хвилин з телефона, з будь-якого міста. Звіт у PDF до 5 хвилин після тесту.", price: "від 2 500 ₴", cta: "Пройти онлайн" },
  ...
  ru: {
    ...
    online: { title: "VerifEye онлайн", text: "До 15 минут с телефона, из любого города. Отчёт в PDF до 5 минут после теста.", price: "от 2 500 ₴", cta: "Пройти онлайн" },
  ...
  en: {
    ...
    online: { title: "VerifEye online", text: "Up to 15 minutes from a phone, from any city. PDF report within 5 minutes after the test.", price: "from UAH 2,500", cta: "Take the online test" },
