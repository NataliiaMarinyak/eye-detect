...
const shared = {
  uk: {
    ...
    office: { title: "EyeDetect у кабінеті або з виїздом", text: "30–45 хвилин на обладнанні Converus у Львові або з виїздом. Звіт того ж дня.", price: "від 5 500 ₴", cta: "Записатися" },
  ...
  ru: {
    ...
    office: { title: "EyeDetect в кабинете или с выездом", text: "30–45 минут на оборудовании Converus во Львове или с выездом. Отчёт в тот же день.", price: "от 5 500 ₴", cta: "Записаться" },
...
export const situations = [
  {
    ...
    uk: {
      ...
      sub: "Коли підозри не дають жити, а розмови ходять по колу, тест ставить крапку. Конкретні питання про конкретний період, результат того ж дня, і ніхто, крім вас, його не побачить.",
      facts: ["результат того ж дня", "онлайн або в кабінеті", "лише ви бачите звіт"],
      how: [
        ...
        { title: "Обидва партнери читають питання заздалегідь", text: "Перед тестом людина читає повне пояснення кожного питання: що вважається контактом, що ні, за який період. Несподіванок і пасток немає, тому результат неможливо оскаржити словами «я не так зрозумів»." },
      ...
      faq: [
        ...
        { q: "Що, як результат «невизначений»?", a: "Так буває приблизно в одному випадку з десяти, найчастіше через втому або хвилювання. Повторний тест зі знижкою 50%." },
        { q: "Чи дізнається хтось про тест?", a: "Ні. Ми не публікуємо фото й відгуки без дозволу, не обговорюємо перевірки і не зберігаємо звіти довше, ніж потрібно для видачі результату." },
      ],
    },
    ru: {
      nav: "Верность",
      seo: {
        ...
        description: "Тест на верность партнёра: EyeDetect во Львове за 30–45 мин или VerifEye онлайн с телефона за 15 мин. Конкретные вопросы, результат в тот же день, полная конфиденциальность.",
        keywords: ["проверка на верность", "тест на верность", "детектор лжи измена", "полиграф верность", "проверить партнёра"],
      },
      h1: "Проверка на верность: узнать правду за одну встречу или онлайн",
      sub: "Когда подозрения не дают жить, а разговоры ходят по кругу, тест ставит точку. Конкретные вопросы о конкретном периоде, результат в тот же день, и никто, кроме вас, его не увидит.",
      facts: ["результат в тот же день", "онлайн или в кабинете", "только вы видите отчёт"],
      how: [
        ...
        { title: "Оба партнёра читают вопросы заранее", text: "Перед тестом человек читает полное объяснение каждого вопроса: что считается контактом, что нет, за какой период. Неожиданностей и ловушек нет, поэтому результат нельзя оспорить словами «я не так понял»." },
      ...
      faq: [
        ...
        { q: "Что, если результат «неопределённый»?", a: "Так бывает примерно в одном случае из десяти, чаще всего из-за усталости или волнения. Повторный тест со скидкой 50%." },
        { q: "Узнает ли кто-то о тесте?", a: "Нет. Мы не публикуем фото и отзывы без разрешения, не обсуждаем проверки и не храним отчёты дольше, чем нужно для выдачи результата." },
      ],
    },
  },
  {
    ...
    uk: {
      ...
      facts: ["6–8 осіб за день", "виїзд у ваш офіс", "звіт по кожному того ж дня"],
      how: [
    ...
    ru: {
      ...
      h1: "Кто взял деньги: проверка на детекторе лжи сужает круг за день",
      ...
      facts: ["6–8 человек в день", "выезд в ваш офис", "отчёт по каждому в тот же день"],
      how: [
  ...
  },
  {
    ...
    uk: {
      ...
      seo: {
        ...
        description: "Конкуренти дізналися ціни, клієнтську базу або плани. EyeDetect перевіряє, хто передавав дані, без звинувачень навмання. 6–8 осіб за день, звіт того ж дня.",
    ...
    ru: {
      ...
      seo: {
        ...
        description: "Конкуренты узнали цены, клиентскую базу или планы. EyeDetect проверяет, кто передавал данные, без обвинений наугад. 6–8 человек в день, отчёт в тот же день.",
      ...
      h1: "Утечка данных клиентов или коммерческой тайны: найти источник",
  ...
  },
  {
    ...
    uk: {
      ...
      seo: {
        ...
        description: "Перевірка кандидата на EyeDetect за 30–45 хвилин: судимості, наркотики, крадіжки на попередніх місцях, приховані факти в резюме. Звіт того ж дня, Львів і виїзд.",
      ...
      facts: ["30–45 хвилин на кандидата", "стандартні теми або ваші", "звіт того ж дня"],
      how: [
    ...
    ru: {
      ...
      seo: {
        ...
        description: "Проверка кандидата на EyeDetect за 30–45 минут: судимости, наркотики, кражи на предыдущих местах, скрытые факты в резюме. Отчёт в тот же день, Львов и выезд.",
      ...
      h1: "Проверка кандидата перед наймом: факты вместо резюме",
      ...
      facts: ["30–45 минут на кандидата", "стандартные темы или ваши", "отчёт в тот же день"],
      how: [
  ...
  },
  {
    ...
    uk: {
      ...
      facts: ["одна зустріч", "обидві сторони можуть пройти", "звіт того ж дня"],
      how: [
    ...
    ru: {
      ...
      h1: "Когда есть только слова: объективная основа для решения",
      ...
      facts: ["одна встреча", "обе стороны могут пройти", "отчёт в тот же день"],
      how: [
