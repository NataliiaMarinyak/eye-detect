...
const how = {
  uk: { type: "steps", tone: "white", title: "Як проходить перевірка", items: [
    ...
    { title: "Звіт і пояснення", text: "Ви отримуєте PDF-звіт того ж дня, спеціаліст пояснює, що означають цифри і що робити далі." },
  ] },
  ru: { type: "steps", tone: "white", title: "Как проходит проверка", items: [
    ...
    { title: "Отчёт и пояснение", text: "Вы получаете PDF-отчёт в тот же день, специалист объясняет, что означают цифры и что делать дальше." },
  ] },
};
...
export const audiences = [
  ...
  },
  {
    ...
    ru: {
      ...
      hero: { eyebrow: "Банкам и финансовым компаниям", h1: "Проверка сотрудников банка на детекторе лжи: можно ли доверять тем, кто имеет доступ к деньгам", sub: "Опытный менеджер с 25 годами стажа и новый кассир одинаково имеют доступ к счетам. Проверка кандидатов перед наймом и периодическая проверка сотрудников на EyeDetect снижает риск краж, мошенничества и утечки данных клиентов.", facts: ["6–8 человек в день", "выезд в офис", "отчёт по каждому в тот же день", "письменное согласие сотрудника"] },
      blocks: [
