...
export const audiences = [
  ...
  },
  {
    ...
    ru: {
      ...
      hero: { eyebrow: "HR и рекрутерам", h1: "Проверка кандидата со смартфона до собеседования", sub: "VerifEye — приложение Converus, которое за 10 минут проверяет кандидата на его собственном телефоне: честное ли резюме, были ли кражи на предыдущей работе, употребляет ли наркотики. Мы готовим вопросы, отправляем ссылку, вы получаете результат. Для удалённых команд и региональных филиалов.", facts: ["10 минут", "из любого города", "точность 84–89%", "от 2 500 ₴ за тест"] },
      blocks: [
  ...
  },
  {
    ...
    uk: {
      ...
      hero: { eyebrow: "Психологам і сімейним консультантам", h1: "Факти замість здогадок у роботі з парою", sub: "Коли один партнер підозрює, а інший заперечує, терапія ходить по колу. 15-хвилинний тест EyeDetect дає обом конкретну відповідь на конкретне питання і дозволяє працювати з реальністю, а не з версіями. Без датчиків, без екзаменатора з дротами, який ламає довіру в кабінеті.", facts: ["15 хвилин на одне питання", "без датчиків на тілі", "результат того ж дня", "Львів або виїзд"] },
      blocks: [
