  ...
  uk: {
    ...
    blocks: [
      ...
      { type: "text", title: "Партнерська модель для агенції", paragraphs: [
        ...
        "Два формати. VerifEye: кандидат проходить тест на своєму смартфоні з будь-якого міста, близько 10 хвилин, точність 84–89%, від 2 500 ₴. EyeDetect: 30–45 хвилин у кабінеті у Львові або з виїздом до клієнта, 6–8 людей за день, точність 86–90%, від 5 500 ₴. Виїзд по Львівській області включено, Західна Україна +2 000 ₴, інші регіони від 12 000 ₴ разом з тестом.",
  ...
  ru: {
    ...
    blocks: [
      { type: "cards", title: "Где это помогает", items: [
        ...
        { title: "Меньше гарантийных замен", text: "Если кандидат не прошёл испытательный срок из-за кражи или неправды в резюме, агентство ищет замену бесплатно. Тест до оффера уменьшает количество таких случаев." },
      ...
      { type: "text", title: "Партнёрская модель для агентства", paragraphs: [
        ...
        "Два формата. VerifEye: кандидат проходит тест на своём смартфоне из любого города, около 10 минут, точность 84–89%, от 2 500 ₴. EyeDetect: 30–45 минут в кабинете во Львове или с выездом к клиенту, 6–8 человек в день, точность 86–90%, от 5 500 ₴. Выезд по Львовской области включён, Западная Украина +2 000 ₴, другие регионы от 12 000 ₴ вместе с тестом.",
