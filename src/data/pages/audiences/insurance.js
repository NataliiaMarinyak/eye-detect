...
export const insurance = {
  slug: "insurance",
  uk: {
    seo: { title: "Детектор брехні для страхової — перевірка заяв EyeDetect", description: "EyeDetect для відділів врегулювання: заяви про ДТП, викрадення авто, майно. Інсценування, завищення збитків, змова з СТО. Тест 30–45 хвилин, звіт одразу.", keywords: ["детектор брехні для страхової", "поліграф страховий випадок", "перевірка заяви про ДТП", "страхове шахрайство перевірка", "EyeDetect страхування"], crumbHome: "Головна", crumb: "Для страхових компаній" },
