...
const blogPosts1 = [
  ...
  },
  {
    ...
    uk: {
      ...
      sections: [
        { h2: "Поради з інтернету і що з ними не так", paragraphs: ["Усі відомі способи протидії розраховані на класичний поліграф: він вимірює дихання, тиск і потовиділення, і ці показники можна змінити свідомо."], list: ["Кнопка в черевику, напруження м'язів: створює штучну реакцію на контрольні питання. Досвідчений поліграфолог бачить це на графіку, а EyeDetect не вимірює тіло взагалі.", "Заспокійливі або алкоголь: притупляють реакції рівномірно, і тест визнається недійсним. На EyeDetect людина у стані сп'яніння до тесту не допускається.", "Рахування в умі, згадування неприємного: розраховане на поліграф, бо змінює дихання і тиск. Зіниця при цьому теж змінюється, але однаково на всіх твердженнях, тому на висновок тесту це не впливає.", "«Повірити у власну брехню»: гарно звучить, але мозок усе одно витрачає більше зусиль на неправдиву відповідь. Саме це зусилля і фіксується."] },
    ...
    en: {
      ...
      sections: [
        { h2: "Tips from the internet and what is wrong with them", paragraphs: ["All the known countermeasures are designed for the classic polygraph: it measures breathing, blood pressure and sweating, and these can be changed deliberately."], list: ["A tack in the shoe, tensing muscles: creates an artificial reaction to control questions. An experienced polygraph examiner sees it on the chart, and EyeDetect does not measure the body at all.", "Sedatives or alcohol: blunt reactions evenly, and the test is declared invalid. On EyeDetect, a person under the influence is not admitted to the test.", "Counting in your head, recalling something unpleasant: aimed at the polygraph, because it changes breathing and blood pressure. The pupil does change too, but equally on all statements, so it does not affect the test's conclusion.", "“Believing your own lie”: sounds good, but the brain still spends more effort on a false answer. That effort is exactly what is recorded."] },
