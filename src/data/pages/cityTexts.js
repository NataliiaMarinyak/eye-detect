  ...
  uk: {
    ...
    faq: {
      ...
      eu: [
        ...
        { q: "Чи можна пройти тест онлайн, не чекаючи виїзду?", a: "Так, VerifEye з телефона доступний уже сьогодні, звіт у PDF до 5 хвилин після тесту." },
  ...
  ru: {
    ...
    faq: {
      ...
      eu: [
        ...
        { q: "Можно ли пройти тест онлайн, не дожидаясь выезда?", a: "Да, VerifEye с телефона доступен уже сегодня, отчёт в PDF до 5 минут после теста." },
  ...
  en: {
    ...
    faq: {
      ...
      eu: [
        ...
        { q: "Can the test be taken online without waiting for a visit?", a: "Yes, VerifEye from a phone is available today, PDF report within 5 minutes after the test." },
