export const gambling = {
  ...
  uk: {
    ...
    faq: [
      ...
      { q: "Партнер лікується від залежності. Чи не зашкодить тест?", a: "Питання лише про факти: ставки, кредити, рахунки за конкретний період. Ми не питаємо про почуття, потяг чи стан здоров'я. Наталія Мариняк, психолог і сертифікований Converus Test Proctor, узгоджує з вами формулювання так, щоб тест не звучав як допит." },
