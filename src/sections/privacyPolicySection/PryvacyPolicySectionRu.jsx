  ...
  return (
    <section className={styles.section}>
      <div className={`container ${styles.container}`}>
        ...
        <p>
          Вся информация, предоставленная пользователями сайта <span>{addressData.siteLink}</span>, обрабатывается в соответствии с этой
          Политикой конфиденциальности личных данных (далее - Политика).
        </p>
        ...
        <p>
          ...
          предпринятые с использованием средств автоматизации или без использования таких средств, с личными данными (включая
        ...
        <p>
          1.1.4. &rdquo;Конфиденциальность личных данных&rdquo; - обязательное соблюдение Оператором или другим лицом, имеющим доступ к персональным данным, требований по предотвращению их распространения
          без согласия Пользователя или другого правового основания.
        </p>
        <p>
        ...
        <p>
          1.1.6. &rdquo;Cookie&rdquo; - небольшой фрагмент данных, отправленный веб-сервером, хранящийся на компьютере пользователя, который веб-браузер каждый раз
          отправляет веб-серверу в НТТР запросе, когда он пытается
          открыть страницу соответствующего сайта.
        </p>
        <p>
          1.1.7. &rdquo;IP адрес&rdquo; - уникальный адрес узла в
        ...
        <p>
          ...
          доменном имени <span>{addressData.siteDomain}</span> (далее - &rdquo;Заказ&rdquo;), -
          услуги, указанные Клиентом при оформлении электронного запроса на
          покупку услуг, оформленного с использованием механизмов сайта в системе онлайн на основании намерения Клиента получить услуги, и переданные
          Подрядчику посредством использования механизмов сайта.
        </p>
        <p>
          1.1.10. Клиент (далее &rdquo;Клиент&rdquo;) - физическое лицо,
          посетитель сайта, принимающий условия договора об обслуживании
          (выполнении работ) в области информационных технологий, осуществляющий заказ с использованием механизмов сайта исключительно для личных,
        ...
        <p>
          ...
          неразглашению и обеспечению защиты конфиденциальности персональных данных, которые Пользователь
          должен предоставить по запросу Администрации или при оформлении Услуги.
        </p>
        <p>
        ...
        <p>
          ...
          просмотра рекламныч блоков и при посещение страниц, на которых установлен
          статистический скрипт системы (&ldquo;пиксель&ldquo;):
        </p>
        <p>а) IP адрес</p>
        <p>б) информация из cookie;</p>
        <p>
          в) информация о браузере (или о другом приложении, которое осуществляет доступ к показу
          рекламы);
        </p>
        <p>г) время доступа;</p>
        ...
        <p>
          ...
          технических проблем, контроля законности проводимых
          финансовых платежей, или иных целей Компании, не противоречащих
        ...
        <p>
          ...
          хранится и не распространяется, за исключением случаев, предусмотренных
        ...
        <p>
          ...
          специальных предложений, информации о ценах, информационных бюллетеней
          и другой информация от имени сайта или от имени партнеров по сайту.
        </p>
        <p>
          {" "}
        ...
        <p>
          ...
          Заказа, контроля качества обслуживания клиентов, своевременного предоставления
          клиентам  информации об обновлении продукции, специальных
          предложений, информации о ценах, рассылки новостей и другой
          информации от имени сайта или от имени партнеров сайта, оформленного
          на сайте, включая случаи участия представителей Компании в организации
        ...
        <p>
          5.4. При потере или раскрытии личных данных Администрация информирует Пользователя о
