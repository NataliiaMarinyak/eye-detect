  ...
  return (
    <section className={styles.section}>
      <div className={`container ${styles.container}`}>
        ...
        <p>
          Вся інформація надана Користувачами сайту <span>{addressData.siteLink}</span>, обробляється відповідно до цієї
        ...
        <p>
          ...
          запис, систематизація, накопичення, зберігання, уточнення (оновлення,
          зміна), витяг, використання, передача (поширення, надання, доступ),
        ...
        <p>
          1.1.7. &rdquo;IP-адреса&rdquo; – унікальна адреса вузла в
          комп’ютерній мережі, яка побудована за протоколом IP.
        </p>
        <p>
        ...
        <p>
          ...
          розташованого на доменному імені <span>{addressData.siteDomain}</span> (далі –
        ...
        <p>
          ...
          надаються Користувачем шляхом заповнення форми на сайті
        ...
        <p>
          ...
          виключно стороною Адміністрації в цілях поліпшення якості
        ...
        <p>
          4.1. Персональні дані Користувача Адміністрація може використовувати в наступних
          цілях:
        </p>
        <p>
